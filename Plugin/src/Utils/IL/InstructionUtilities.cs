...
internal static class InstructionUtilities
{
    ...
    public static int PopCount(this CodeInstruction instruction)
    {
        ...
        return instruction.opcode.StackBehaviourPop switch
        {
            ...
            StackBehaviour.Varpop => throw new NotImplementedException(
                $"Variable pop on non-call instruction '{instruction}'"),
            StackBehaviour.Popref_popi_pop1 => 3,
            _ => throw new NotSupportedException(
                $"StackBehaviourPop of {instruction.opcode.StackBehaviourPop} was not a pop for instruction '{instruction}'"),
        };
    }
    ...
    public static int PushCount(this CodeInstruction instruction)
    {
        ...
        return instruction.opcode.StackBehaviourPush switch
        {
            ...
            StackBehaviour.Varpush => throw new NotImplementedException(
                $"Variable push on non-call instruction '{instruction}'"),
            _ => throw new NotSupportedException(
                $"StackBehaviourPush of {instruction.opcode.StackBehaviourPush} was not a push for instruction '{instruction}'"),
        };
    }
